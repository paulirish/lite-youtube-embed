 ...
 */
class LiteVMEmbed extends HTMLElement {
  connectedCallback() {
    ...
    this.addEventListener("pointerover", LiteVMEmbed.warmConnections, {
      once: true,
    });
  ...
  addIframe() {
    ...
    iframeEl.src = `https://player.vimeo.com/video/${encodeURIComponent(
      this.videoId
    )}?${params.toString()}`;
...
customElements.define("lite-vimeo", LiteVMEmbed);
